...
-- Show username, comment and photo ID
SELECT username, contents, photo_id
FROM comments
JOIN users
ON users.id = comments.user_id;

-- Show photo URL with comments
SELECT url, contents
FROM comments
JOIN photos
ON comments.photo_id = photos.id;

-- Show matching comment ID and photo ID
SELECT comments.id, photos.id
FROM comments
JOIN photos
ON comments.photo_id = photos.id;

-- Show comment ID and photo ID using aliases
